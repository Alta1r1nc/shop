            ...
            <form class="product-form" action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-column">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-textarea @error('description') error @enderror"
                                placeholder="Добавьте описание товара">{{ old('description', $product->description) }}</textarea>
                            ...
                            <div class="file-upload">
                                ...
                                <label class="file-upload-label">
                                    ...
                                    <span class="file-custom @error('image') error @enderror">
                                        {{ $product->image ? 'Изменить файл' : 'Выберите файл' }}
                                    </span>
                                </label>
                    ...
                    <div class="form-column">
                        ...
                        <div class="form-group">
                            ...
                            <select name="type" class="form-select @error('type') error @enderror">
                                <option value="механические" {{ old('type', $product->type) == 'механические' ? 'selected' : '' }}>Механические</option>
                                <option value="электронные" {{ old('type', $product->type) == 'электронные' ? 'selected' : '' }}>Электронные</option>
                                <option value="кварцевые" {{ old('type', $product->type) == 'кварцевые' ? 'selected' : '' }}>Кварцевые</option>
                            </select>
                ...
                <div class="form-footer">
                    <button type="submit" class="form-submit-btn">
                        <img src="{{ asset('assets/media/adm_panel/edit.svg') }}" alt="Редактировать">
                        Сохранить изменения
                    </button>
                </div>
            </form>
